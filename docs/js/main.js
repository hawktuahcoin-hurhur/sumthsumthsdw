  ...
  "characters": [
    {
      ...
      "description": "The main protagonist. An orphan from the outskirts who awakens with the Shadow Slave Aspect. His Flaw 'Clear Conscience' means he cannot lie.",
      "type": "protagonist",
      "aspect": "Shadow Slave",
    ...
    },
    {
      ...
      "description": "A silver-haired girl from Clan Valor. Her Aspect allows her to ignite with inner fire. Her Flaw means she must suffer to use her power.",
      "type": "main",
    ...
    },
    {
      ...
      "description": "A blind girl with the gift of prophecy. Her visions are terrifyingly accurate. Later associated with Clan Song.",
      "type": "main",
      "aspect": "Oracle",
      "clan": "Song",
      "rank_progression": [
    ...
    },
    {
      ...
      "description": "A handsome young man found in a well on the Forgotten Shore. His Aspect 'Nightingale' gives his voice special powers.",
      "type": "main",
      "aspect": "Nightingale",
      "clan": "None",
      "rank_progression": [
